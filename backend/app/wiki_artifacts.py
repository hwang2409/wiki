...
TOOL_DESCRIPTION = (
    ...
    "video/mp4, video/webm, or image/gif. video/webm accepts exactly one VP8 video track, "
    "with keyframes only and no audio. video bytes are capped at 40MB, and the optional poster "
...
_PAYLOAD_DESCRIPTION = (
    ...
    "video/mp4|video/webm|image/gif; video/webm accepts exactly one VP8 video track, "
    "with keyframes only and no audio; data_base64 or path is required; video is capped at 40MB; "
