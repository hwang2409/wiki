...
- [P1] WIKI-153 transcript debug-detail: tools/bash results/hook markers/artifact inspector — human summaries primary; raw input/output/event JSON bounded, labelled, copyable, opt-in; internal-only hooks hidden
