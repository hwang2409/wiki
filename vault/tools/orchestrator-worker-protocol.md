...
| Review worker | cc | claude-fable-5 |

**Reviewer change (Henry 2026-08-06): review workers are now cc claude-fable-5, replacing cdx gpt-5.6-sol.** Henry: "gpt-5.6-luna implementation worker -> fable reviewer... a lot better." Applies to all repos/orchestrators unless a ticket overrides. Sol remains the fallback only if fable spawns block on credits again.
