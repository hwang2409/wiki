...
- **PERF ARC COMPLETE 07-09** — #28 WIKI-32 merged: central transcript store, visible-only polling (28→7 req/15s), scoped SSE, path-namespaced patch-by-id deltas (500KB→~300B/tick), WIKI-18 landing-poll bug dead. Wiki queue: WIKI-24 window-switch state preservation (P1), WIKI-27 header jump, WIKI-34 watchdog same-day reset parse, WIKI-35 session-view status banner, WIKI-36 backend registry env override (P1).
