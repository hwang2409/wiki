...
- Split panes (2026-07-06): drag a file from the tree onto a workspace edge (left/right/top/bottom) → secondary pane opens there; center drop = open in main pane. Secondary pane is read-view + full kanban interactivity, ephemeral (not in URL). Cmd+B toggles sidebar; Cmd+K quick switcher.
