...
# Wiki.app UI/UX census (WIKI-385, 2026-08-25)

Audit worker: WIKI-385-AUDIT1 (cdx sol). Artifacts: branch `wiki-385-audit`, `audit/wiki-385-census.md` + `audit/screenshots/`. Ticket ladder filed as WIKI-384, WIKI-386..398. Related: [[polish-census]], [[formatting-delta-census]], [[closing-audit-2026-08-17]].
