...
- Remove the startup palette scan. Search live SQLite artifacts and at most the 40 newest committed archived sessions. Cache each unchanged archived file's artifact events. Reuse the full archived session list across a short typing burst. This leaves the first palette search with a bounded archive read.
